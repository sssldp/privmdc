...
from ng.DataSynthesizer.lib.utils import mutual_information, normalize_given_distribution, set_random_seed
...
def greedy_bayes(dataset: pd.DataFrame, k: int, epsilon: float, seed=0, debug=False):
    ...
    dataset: pd.DataFrame = dataset.astype(str, copy=False)
