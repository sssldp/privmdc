...
from ng.DataSynthesizer.datatypes.AbstractAttribute import AbstractAttribute
from ng.DataSynthesizer.datatypes.DateTimeAttribute import is_datetime, DateTimeAttribute
from ng.DataSynthesizer.datatypes.FloatAttribute import FloatAttribute
from ng.DataSynthesizer.datatypes.IntegerAttribute import IntegerAttribute
from ng.DataSynthesizer.datatypes.SocialSecurityNumberAttribute import is_ssn, SocialSecurityNumberAttribute
from ng.DataSynthesizer.datatypes.StringAttribute import StringAttribute
from ng.DataSynthesizer.datatypes.utils.DataType import DataType
from ng.DataSynthesizer.lib import utils
from ng.DataSynthesizer.lib.PrivBayes import greedy_bayes, construct_noisy_conditional_distributions
import warnings
...
class DataDescriber:
    ...
    def read_dataset_from_csv(self, file_name=None):
        try:
            self.df_input = read_csv(file_name, skipinitialspace=True, na_values=self.null_values, sep=",")
        except (UnicodeDecodeError, NameError):
            self.df_input = read_csv(file_name, skipinitialspace=True, na_values=self.null_values, encoding='latin1')
